...
import co.ecg.jain_sip.sdp.fields.*;
...
public class SessionDescriptionImpl implements SessionDescription {
    ...
    public SessionDescriptionImpl(SessionDescription otherSessionDescription)
        ...
        if (otherConnection != null) {
            this.setConnection(SerializationUtils.clone(otherConnection));
        }

        // OK to clone the key field, just a couple of strings
        Key otherKey = (Key) otherSessionDescription.getKey();
        if (otherKey != null) {
            this.setKey(SerializationUtils.clone(otherKey));
        }
        ...
        if (otherTimeDescriptions != null) {
            ...
            while (itTimeDescriptions.hasNext()) {
                ...
                if (otherTimeDescription != null) {
                    TimeField otherTimeField = (TimeField) SerializationUtils.clone(otherTimeDescription.getTime());
                    ...
                    if (otherRepeatTimes != null) {
                        ...
                        while (itRepeatTimes.hasNext()) {
                            ...
                            if (otherRepeatField != null) {
                                ...
                                RepeatField newRF = (RepeatField) SerializationUtils.clone(otherRepeatField);
        ...
        if (otherEmails != null) {
            ...
            while (itEmails.hasNext()) {
                ...
                if (otherEmailField != null) {
                    ...
                    EmailField newEF = (EmailField) SerializationUtils.clone(otherEmailField);
                    newEmails.add(newEF);
                }
            }
        ...
        if (otherPhones != null) {
            ...
            while (itPhones.hasNext()) {
                ...
                if (otherPhoneField != null) {
                    ...
                    PhoneField newPF = (PhoneField) SerializationUtils.clone(otherPhoneField);
                    newPhones.add(newPF);
                }
            }
        ...
        if (otherZAs != null) {
            ...
            while (itZAs.hasNext()) {
                ...
                if (otherZoneField != null) {
                    ...
                    ZoneField newPF = (ZoneField) SerializationUtils.clone(otherZoneField);
                    newZAs.add(newPF);
                }
            }
        ...
        if (otherBandwidths != null) {
            ...
            while (itBandwidths.hasNext()) {
                ...
                if (otherBandwidthField != null) {
                    BandwidthField newBF = (BandwidthField) SerializationUtils.clone(otherBandwidthField);
        ...
        if (otherAttributes != null) {
            ...
            while (itAttributes.hasNext()) {
                ...
                if (otherAttributeField != null) {
                    AttributeField newBF = SerializationUtils.clone(otherAttributeField);
            ...
            while (itMediaDescriptions.hasNext()) {
                ...
                if (otherMediaDescription != null) {
                    ...
                    if (otherInfoField != null) {
                        newMD.setInformationField((InformationField) SerializationUtils.clone(otherInfoField));
                    }
                    ...
                    if (otherConnectionField != null) {
                        newMD.setConnectionField((ConnectionField) SerializationUtils.clone(otherConnectionField));
                    }
                    ...
                    if (otherBFs != null) {
                        ...
                        while (itBFs.hasNext()) {
                            ...
                            if (otherBF != null) {
                                ...
                                newBFs.add((BandwidthField) SerializationUtils.clone(otherBF));
                            }
                        }
                    ...
                    if (otherKeyField != null) {
                        newMD.setKeyField((KeyField) SerializationUtils.clone(otherKeyField));
                    }
                    ...
                    if (otherAFs != null) {
                        ...
                        while (itAFs.hasNext()) {
                            ...
                            if (otherAF != null) {
                                ...
                                newAFs.add((AttributeField) SerializationUtils.clone(otherAF));
                            }
                        }
