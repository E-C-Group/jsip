...
public class SipUri extends GenericURI implements SipURI, SipURIExt{
        ...
        if (that instanceof SipURI) {
            ...
            if(a.getHeaderNames().hasNext() && b.getHeaderNames().hasNext()) {
                ...
                try {
                    ...
                    log.error("Cannot get the header factory to parse the header of the sip uris to compare", e);
                    return false;
                }
                for (Iterator i = a.getHeaderNames(); i.hasNext();) {
                    ...
                    try {
                        ...
                        log.error("Cannot parse one of the header of the sip uris to compare " + a + " " + b, e);
                        return false;
                    }
                }
            }
    ...
    */
     ...
     * are defined in the {@link ListeningPoint}.
     *
