...
public class SIPClientTransactionImpl extends SIPTransactionImpl implements SIPClientTransaction {
    ...
    /**
     * @see SIPClientTransaction#setResponseInterface(ServerResponseInterface)
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#getRequestChannel()
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#isMessagePartOfTransaction(SIPMessage)
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#sendMessage(SIPMessage)
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#processResponse(SIPResponse,
     * MessageChannel, SIPDialog)
     */
    @Override
    public synchronized void processResponse(SIPResponse transactionResponse,
        ...
        if (log.isDebugEnabled()) {
            log.debug("processing " + transactionResponse.getFirstLine() + "current state = "
                    + getState());
        ...
        if (transactionTimer != null && timerKStarted.compareAndSet(false, true)) {
            synchronized (transactionTimerLock) {
                if (!transactionTimerCancelled) {
                    ...
                    if (log.isDebugEnabled()) {
                        log.debug("starting TransactionTimerK() : " + getTransactionId() + " time "
                                + time);
                    }
    ...
    private void inviteClientTransaction(SIPResponse transactionResponse,
        ...
        if (TransactionState._TERMINATED == this.getInternalState()) {
            ...
            if (log.isDebugEnabled() && dialog != null)
                log.debug("Dialog " + dialog + " current state " + dialog.getState());
            if (dialog == null && statusCode >= 200 && statusCode < 300) {
                ...
                if (log.isDebugEnabled())
                    log.debug("Client Transaction " + this + " branch id " + getBranch()
                            + " doesn't have any dialog and is in TERMINATED state");
                if (respondTo != null) {
                    if (log.isDebugEnabled())
                        log.debug("passing 2xx response up to the application");
                ...
                if (log.isDebugEnabled())
                    log.debug("Client Transaction " + this + " branch id " + getBranch() + " has a early dialog and is in TERMINATED state");
    ...
    /**
     * @see SIPClientTransaction#sendRequest()
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#createAck()
     */
    @Override
    public Request createAck() throws SipException {
        ...
        if (recordRouteList == null) {
            ...
            if (lastResponse.getContactHeaders() != null && lastResponse.getStatusCode() / 100 != 3) {
                ...
                URI uri = SerializationUtils.clone(contact.getAddress().getURI());
        ...
        while (li.hasPrevious()) {
            ...
            route.setAddress(SerializationUtils.clone(rr.getAddress()));
            route.setParameters(SerializationUtils.clone(rr.getParameters()));
            routeList.add(route);
        }
        ...
        if (!((SipURI) ((Route) routeList.getFirst()).getAddress().getURI()).hasLrParam()) {
            ...
            if (contact != null) {
                route = new Route();
                route.setAddress(SerializationUtils.clone(contact.getAddress()));
            }
    ...
    /**
     * @see SIPClientTransaction#setViaPort(int)
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#setViaHost(String)
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#getViaPort()
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#getViaHost()
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#getOutgoingViaHeader()
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#clearState()
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#setState(int)
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#terminate()
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#stopExpiresTimer()
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#checkFromTag(SIPResponse)
     */
    @Override
    public boolean checkFromTag(SIPResponse sipResponse) {
        ...
        if (this.defaultDialog != null) {
            if (originalFromTag == null ^ sipResponse.getFrom().getTag() == null) {
                if (log.isDebugEnabled())
                    log.debug("From tag mismatch -- dropping response");
                return false;
            }
    ...
    public void processResponse(SIPResponse sipResponse, MessageChannel incomingChannel) {
        ...
        if (log.isDebugEnabled()) {
            log.debug("marking response as retransmission " + isRetransmission + " for ctx " + this);
        }
    ...
    /**
     * @see SIPClientTransaction#getDialog()
     */
    @Override
    public Dialog getDialog() {
        ...
        if (log.isDebugEnabled()) {
            log.debug(" sipDialogs =  " + sipDialogs + " default dialog " + this.getDefaultDialog()
                    + " retval " + retval);
        }
        return retval;
    ...
    /**
     * @see SIPClientTransaction#getDialog(String)
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#setDialog(SIPDialog,
     * String)
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#getDefaultDialog()
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#setNextHop(Hop)
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#getNextHop()
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#setNotifyOnRetransmit(boolean)
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#isNotifyOnRetransmit()
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#alertIfStillInCallingStateBy(int)
     */
    @Override
    ...
    protected void cleanUpOnTimer() {
        if (isReleaseReferences()) {
            if (log.isDebugEnabled()) {
                log.debug("cleanupOnTimer: " + getTransactionId());
            }
    ...
    /**
     * @see SIPClientTransaction#cleanUp()
     */
    @Override
    public void cleanUp() {
        if (isReleaseReferences()) {
            ...
            if (log.isDebugEnabled()) {
                log.debug("cleanup : " + getTransactionId());
            }
            if (defaultDialog != null) {
    ...
    protected void cleanUpOnTerminated() {
        if (log.isDebugEnabled()) {
            log.debug("removing  = " + this + " isReliable " + isReliable());
        }
        if (isReleaseReferences()) {
    ...
    /**
     * @see SIPClientTransaction#getOriginalRequestFromTag()
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#getOriginalRequestCallId()
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#getOriginalRequestEvent()
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#getOriginalRequestContact()
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#getOriginalRequestScheme()
     */
    @Override
    ...
    /**
     * @see SIPClientTransaction#setTerminateDialogOnCleanUp(boolean)
     */
