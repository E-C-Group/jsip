        ...
        if (readingHttp) {
            ...
            if (s.endsWith("\r\n") || s.endsWith("\n")) {
                ...
                if (!httpInput.startsWith("HTTP")) {
                    ...
                    log.debug("HTTP Response. We are websocket client.\n" + httpInput);
                }
            }
            ...
            do {
                ...
                if (codec.isCloseOpcodeReceived()) {
                    ...
                    log.debug("Websocket close, sending polite close response");
                ...
                log.debug("Nio websocket bytes were added " + decodedMsg.length);
