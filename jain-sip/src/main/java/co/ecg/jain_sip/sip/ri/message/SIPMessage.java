...
//        StringBuilder encoding = new StringBuilder();
        ...
        return contentLengthHeader.encode(encoding).append(Separators.NEWLINE);
    }
     ...
     * identify dialogs.
     *
     * @param isServer is a flag that indicates whether this is a server transaction.
     */
     ...
     * @throws SIPDuplicateHeaderException if the header is of a type that cannot tolerate
