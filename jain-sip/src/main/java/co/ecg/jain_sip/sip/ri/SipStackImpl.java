...
import co.ecg.jain_sip.core.ri.net.*;
...
public class SipStackImpl extends SIPTransactionStack implements SipStack, SipStackExt {
    ...
    public SipStackImpl(Properties configurationProperties)
        ...
        if (clientAuthType != null) {
            ...
            log.info("using " + clientAuthType + " tls auth policy");
        }
        ...
        if (maxConnections != null) {
            try {
                ...
                log.error("max connections - bad value " + ex.getMessage());
            }
        }
        ...
        if (threadPoolSize != null) {
            try {
                ...
                log.error("thread pool size - bad value " + ex.getMessage());
            }
        }
        ...
        try {
            ...
            log.error("maxMessageSize - bad value " + ex.getMessage());
        }
        ...
        if (interval != null) {
            try {
                ...
                log.error("THREAD_AUDIT_INTERVAL_IN_MILLISECS - bad value ["
        ...
        if (messageLogFactoryClasspath != null) {
            try {
                ...
                log.error("Bad configuration value for LOG_FACTORY -- using default logger");
        ...
        if (tlsClientProtocols != null) {
            ...
            log.debug("TLS Client Protocols = ");
            int i = 0;
            while (st.hasMoreTokens()) {
                protocols[i] = st.nextToken();

                log.debug("TLS Client Protocol = " + protocols[i]);
        ...
        log.debug("created Sip stack. Properties = " + configurationProperties);
    ...
    public synchronized ListeningPoint createListeningPoint(String address,
        ...
        log.debug("createListeningPoint : address = " + address + " port = "
        ...
        if (lip != null) {
            ...
            try {
                ...
                log.debug("Created Message Processor: " + address
                        + " port = " + port + " transport = "
                        + transport);
                ...
                log.error("Invalid argument address = " + address + " port = "
                        + port + " transport = " + transport);
    ...
    public SipProvider createSipProvider(ListeningPoint listeningPoint)
        ...
        log.debug("createSipProvider: " + listeningPoint);
     ...
     *
     * @see SipStack#createListeningPoint(String, int,
     * String)
     * @deprecated
     */
    ...
    public void stop() {
        ...
        log.debug("stopStack -- stopping the stack");
     ...
     *
     * @param newCipherSuites String[] The new set of ciphers to support.
     * @return
     */
     ...
     *
     * @param newProtocols String[] The new set of protocols to use for outgoing TLS connections.
     * @return
     */
