...
public class SIPServerTransactionImpl extends SIPTransactionImpl implements SIPServerTransaction {
    ...
    class SendTrying extends SIPStackTimerTask {
        ...
        protected SendTrying() {
            if (log.isDebugEnabled())
                log.debug("scheduled timer for " + SIPServerTransactionImpl.this);
    ...
    protected void sendResponse(SIPResponse transactionResponse) throws IOException {
        if (log.isDebugEnabled()) {
            log.debug("sipServerTransaction::sendResponse " + transactionResponse.getFirstLine());
        }
        try {
    ...
    protected SIPServerTransactionImpl(SIPTransactionStack sipStack, MessageChannel newChannelToUse) {
        ...
        if (log.isDebugEnabled()) {
            log.debug("Creating Server Transaction" + this.getBranchId());
        }

    }

    /**
     * @see SIPServerTransaction#setRequestInterface(ServerRequestInterface)
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#getResponseChannel()
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#isMessagePartOfTransaction(SIPMessage)
     */
    @Override
...
//                topViaHeader = (Via) viaHeaders.getFirst();
    ...
    /**
     * @see SIPServerTransaction#processRequest(SIPRequest, MessageChannel)
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#sendMessage(SIPMessage)
     */
    @Override
    public void sendMessage(SIPMessage messageToSend) throws IOException {
        if (log.isDebugEnabled()) {
            log.debug("sipServerTransaction::sendMessage " + messageToSend.getFirstLine());
        }
        ...
        try {
            ...
            try {
                // Provided we have set the branch id for this we set the BID for
                // the
                // outgoing via.
            ...
            if (!checkStateTimers(statusCode)) {
                if (log.isDebugEnabled()) {
                    log.debug("checkStateTimers returned false -- not sending message");
                }
                return;
            }
...
//                    enableTimeoutTimer(TIMER_J);
    ...
    /**
     * @see SIPServerTransaction#getViaHost()
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#getViaPort()
     */
    @Override
    ...
    public void fireRetransmissionTimer() {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("fireRetransmissionTimer() -- " + this + " state " + getState());
            }
    ...
    /**
     * @see SIPServerTransaction#resendLastResponseAsBytes()
     */
    @Override
    public void resendLastResponseAsBytes() throws IOException {
        ...
        if (lastResponse != null) {
            if (log.isDebugEnabled()) {
                log.debug("resend last response " + lastResponse);
            }
...
//                }
            if (log.isDebugEnabled()) {
                log.debug("resend last response " + new String(lastResponseAsBytes));
            }
            ...
            if (isReliable()) {
                if (log.isTraceEnabled()) {
                    ...
                    try {
                        ...
                        if (log.isDebugEnabled()) {
                            log.debug("couldn't reparse last response " + new String(lastResponseAsBytes));
                        }
                    }
                }
    ...
    /**
     * @see SIPTransaction#fireTimeoutTimer()
     */
    public void fireTimeoutTimer() {

        if (log.isDebugEnabled())
            log.debug("SIPServerTransaction.fireTimeoutTimer this = " + this
                    + " current state = " + this.getRealState() + " method = "
                    + this.getMethod());

        if (isInviteTransaction() && sipStack.removeTransactionPendingAck(this)) {
            if (log.isDebugEnabled()) {
                log.debug("Found tx pending ACK - timer H has kicked");
            }
    ...
    /**
     * @see SIPServerTransaction#getLastResponseStatusCode()
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#setOriginalRequest(SIPRequest)
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#sendResponse(Response)
     */
    @Override
            ...
            if (this.pendingReliableResponseAsBytes != null
                ...
                if (!interlockProvisionalResponses) {
                    ...
                    try {
                        ...
                        log.error("Interrupted acquiring PRACK sem");
                        throw new SipException("Cannot acquire PRACK sem");
                    }
            ...
            if (dialog != null) {
                if (statusCode / 100 == 2
                    ...
                    if (dialog.getLocalTag() == null && sipResponse.getToTag() == null) {
                        ...
                        if (log.isDebugEnabled()) {
                            log.debug("assigning toTag : serverTransaction = " + this + " dialog "
    ...
    /**
     * @see SIPServerTransaction#getState()
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#setState(int)
     */
    @Override
    ...
    protected void startTransactionTimerJ(long time) {
        if (this.transactionTimerStarted.compareAndSet(false, true)) {
            if (sipStack.getTimer() != null && sipStack.getTimer().isStarted()) {
                if (log.isDebugEnabled()) {
                    log.debug("starting TransactionTimerJ() : " + getTransactionId() + " time " + time);
                }
                // The timer is set to null when the Stack is
                // shutting down.
                SIPStackTimerTask task = new SIPStackTimerTask() {
                    ...
                    public void runTask() {
                        if (log.isDebugEnabled()) {
                            log.debug("executing TransactionTimerJ() : " + getTransactionId());
                        }
                        fireTimeoutTimer();
                        cleanUp();
                        if (originalRequest != null) {
    ...
    /**
     * @see SIPServerTransaction#equals(Object)
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#getDialog()
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#setDialog(SIPDialog, String)
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#terminate()
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#getReliableProvisionalResponse()
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#prackRecieved()
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#enableRetransmissionAlerts()
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#isRetransmissionAlertEnabled()
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#disableRetransmissionAlerts()
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#setAckSeen()
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#ackSeen()
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#setMapped(boolean)
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#setPendingSubscribe(SIPClientTransaction)
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#scheduleAckRemoval()
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#cleanUp()
     */
    @Override
    public void cleanUp() {
...
//            transactionTimerStarted = null;
    ...
    /**
     * @see SIPServerTransaction#getPendingReliableResponseMethod()
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#getPendingReliableCSeqNumber()
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#getPendingReliableRSeqNumber()
     */
    @Override
    ...
    /**
     * @see SIPServerTransaction#waitForTermination()
     */
    @Override
