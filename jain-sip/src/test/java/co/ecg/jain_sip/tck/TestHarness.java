...
public class TestHarness extends TestCase {
    ...
    private static final String PATH_ECG_JAINSIP = "co.ecg.jain_sip";

    protected static final String IMPLEMENTATION_PATH = "javax.sip.co.ecg.jain_sip.tck.PATH";

    protected static final String ABORT_ON_FAIL = "javax.sip.tck.ABORT_ON_FAIL";

    protected static final String LOG_FILE_NAME = "javax.sip.co.ecg.jain_sip.tck.LOG_FILE";
    ...
    protected String getImplementationPath() {
        return System.getProperties().getProperty(IMPLEMENTATION_PATH, "co.ecg.jain_sip");
    }
    ...
    static void getTIFactories() {
        try {
            ...
            String tiPathName = System.getProperty(IMPLEMENTATION_PATH, PATH_ECG_JAINSIP);
    ...
    static void getRIFactories(boolean autoDialog) {
        try {
            ...
            riFactory.setPathName(PATH_ECG_JAINSIP);
    ...
    public static Properties getRiProperties(boolean autoDialog) {
        ...
        // prefixed javax.sip.co.ecg.jain_sip.tck.ri and add them to the local
        // properties object
        ...
        //@see test.co.ecg.jain_sip.tck.msgflow.SipProviderTest.testSendNullRequest
    ...
    public static Properties getTiProperties() {
        // TODO collect all system properties
        // prefixed javax.sip.co.ecg.jain_sip.tck.ti and add them to the local
        // properties object
