...
public class Shootme extends TestHarness implements SipListener {
    ...
    public void processInvite(RequestEvent requestEvent,
        ...
        try {
            this.inviteCount++;
            log.info("shootme: got an Invite " + this.inviteCount);
            ...
            log.info("Shootme: dialog = " + dialog);
    ...
    private void sendInviteOK() {
        try {
            ...
            log.info("Dialog = " + inviteTid.getDialog());
            log.info("shootme: Dialog state after response: "
            ...
            log.error("unexpceted exception", ex);
            fail("unexpected exception");
        }
    }
    ...
    public void processDialogTerminated(
        ...
        log.info("Dialog terminated event recieved dialog = "
