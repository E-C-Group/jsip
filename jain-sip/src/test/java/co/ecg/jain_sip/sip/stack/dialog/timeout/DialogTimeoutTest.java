 ...
 */
package co.ecg.jain_sip.sip.stack.dialog.timeout;
...
public class DialogTimeoutTest extends ScenarioHarness {
    ...
    public void testDialogTimeoutSipListenerExt() {
        ...
        try {
            this.shootistProtocolObjs = new ProtocolObjects("shootist", "co.ecg.jain_sip", "udp", false, false, true);
            shootist = new Shootist(shootistProtocolObjs);
            SipProvider shootistProvider = shootist.createSipProvider();

            this.shootmeProtocolObjs = new ProtocolObjects("shootme", "co.ecg.jain_sip", "udp", false, false, true);
    ...
    public void testDialogTimeoutAutoDialog() {
        ...
        try {
            this.shootistProtocolObjs = new ProtocolObjects("shootist", "co.ecg.jain_sip", "udp", true, false, true);
            shootist = new Shootist(shootistProtocolObjs);
            SipProvider shootistProvider = shootist.createSipProvider();

            this.shootmeProtocolObjs = new ProtocolObjects("shootme", "co.ecg.jain_sip", "udp", true, false, true);
            ((SipStackImpl) shootmeProtocolObjs.sipStack).setAggressiveCleanup(true);
            shootme = new Shootme(shootmeProtocolObjs);
            SipProvider shootmeProvider = shootme.createSipProvider();
    ...
    public void testDialogTimeoutB2BUABothCalled() {
        ...
        try {
            this.shootistProtocolObjs = new ProtocolObjects("shootist", "co.ecg.jain_sip", "udp", false, true, true);
            shootist = new Shootist(shootistProtocolObjs);
            SipProvider shootistProvider = shootist.createSipProvider();
