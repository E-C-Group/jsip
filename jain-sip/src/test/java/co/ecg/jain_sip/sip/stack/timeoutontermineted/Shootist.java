...
public class Shootist implements SipListener {
    ...
    public void processTransactionTerminated(TransactionTerminatedEvent transactionTerminatedEvent) {
        log.info("[c]Transaction terminated event recieved: " + transactionTerminatedEvent.getClientTransaction());
    ...
    public void processTimeout(TimeoutEvent timeoutEvent) {
        log.info("[c]Transaction timedout event recieved: " + timeoutEvent.getClientTransaction());
    ...
    public void processDialogTerminated(DialogTerminatedEvent dialogTerminatedEvent) {
        log.info("[c]Dialog terminated event recieved: " + dialogTerminatedEvent.getDialog());
