...
public class ProtocolObjects {
    ...
    public ProtocolObjects(String stackname, String pathname, String transport,
        ...
        properties.setProperty("javax.sip.ROUTER_PATH", test.tck.msgflow.callflows.NonSipUriRouter.class.getName());
        ...
        try {
            ...
            test.tck.msgflow.callflows.NonSipUriRouter router = (test.tck.msgflow.callflows.NonSipUriRouter) sipStack.getRouter();
