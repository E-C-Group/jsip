...
import co.ecg.jain_sip.sip.ri.header.AuthorizationList;
...
import co.ecg.jain_sip.sip.ri.header.ExtensionHeaderList;
...
import co.ecg.jain_sip.sip.ri.header.ProxyAuthenticateList;
import co.ecg.jain_sip.sip.ri.header.ProxyAuthorization;
import co.ecg.jain_sip.sip.ri.header.ProxyAuthorizationList;
...
import co.ecg.jain_sip.sip.ri.header.WWWAuthenticateList;
...
import co.ecg.jain_sip.sip.ri.header.ims.PVisitedNetworkIDList;
...
import co.ecg.jain_sip.sip.ri.header.ims.SecurityServer;
import co.ecg.jain_sip.sip.ri.header.ims.SecurityServerList;
