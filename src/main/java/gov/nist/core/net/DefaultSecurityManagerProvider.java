...
public class DefaultSecurityManagerProvider implements SecurityManagerProvider {
    ...
    public void init(Properties properties)
        ...
        if (keyStoreType == null) {
            ...
            log.warn("Using default keystore type " + keyStoreType);
        }
        if (keyStoreFilename == null || keyStorePassword == null) {
            log.warn("TLS server settings will be inactive - TLS key store will use JVM defaults"
        ...
        if(trustStorePassword == null) {
        	log.info("javax.net.ssl.trustStorePassword is null, using the password passed through javax.net.ssl.keyStorePassword");
        ...
        if (trustStoreType == null) {
            ...
            log.warn("Using default truststore type " + trustStoreType);
        }
        if (trustStoreFilename == null || trustStorePassword == null) {
            log.warn("TLS trust settings will be inactive - TLS trust store will use JVM defaults."
        ...
        if (logger.isLoggingEnabled(LogWriter.TRACE_DEBUG)) {
            log.debug("SecurityManagerProvider " + this.getClass().getCanonicalName() + " will use algorithm " + algorithm);
        }
        ...
        if (logger.isLoggingEnabled(LogWriter.TRACE_DEBUG)) {
        	log.debug("TLS settings OK. SecurityManagerProvider " + this.getClass().getCanonicalName() + " initialized.");
        }
    }
